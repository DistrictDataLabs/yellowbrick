...
=================   ==============================
Visualizer           `PredictionError <https://www.scikit-yb.org/en/latest/api/regressor/peplot.html>`_
Quick Method         `prediction_error() <https://www.scikit-yb.org/en/latest/api/regressor/peplot.html#yellowbrick.regressor.peplot.prediction_errorr>`_
Models               Regression
