...
What were some of the key achievements and successes this past semester?
...
1. Managing Dependency Upgrades (Discussion Leader: Ben)
   ...
   a. Overarching Question: How do we manage this technical debt?
      ...
      v.   Ben proposed that we fix test dependency with == and maintain knowledge of upgrades.
         He notes that it is a risky approach because we have to stay on top of changes in dependencies.
