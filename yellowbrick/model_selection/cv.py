...
# Updated:  Sat Aug 4 11:52:02 2018 -0500
#
...
class CVScores(ModelVisualizer):
    ...
    This visualizer is a wrapper for the `sklearn.model_selection.cross_val_score
    <http://scikit-learn.org/stable/modules/generated/sklearn.model_selection.cross_val_score.html>`_

    Refer to the scikit-learn `cross-validation guide
    <http://scikit-learn.org/stable/modules/cross_validation.html>`_ for more details.
    ...
    def draw(self, **kwargs):
        ...
        # update minimum if it is greater than 0.05 to remove whitespace
        # in the bottom of the chart for easier comparison of values
        if minimum > 0.05:
        ...
        self.ax.axhline(
            self.cv_scores_mean_, color=color, label='Average',
